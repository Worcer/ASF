...
from components.buttons.kick_buttons import KickButtons
...
class Masskick(commands.Cog):
    ...
    async def masskick_command(self, ctx: Interaction, 
        ...
        if (not guild.me.guild_permissions.kick_members
            ...
            raise commands.BotMissingPermissions(["2"])
